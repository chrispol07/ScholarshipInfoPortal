	...
	<div class="row">
			...
			<div class="card card-info card-primary">
				...
				<div class="card-body">
					<form action="" id="manage-question">
						<input type="hidden" name="event_id" value="<?php echo isset($id) ? $id : '' ?>">
		...
		<div class="col-md-8">
			<div class="card card-outline card-info">
				<div class="card-header">
					<b>Evaluation Questionnaire for: <?php echo $title?> </b>
						...
						?>
							<table class="table table-condensed">
								...
								<tbody class="tr-sortable">
									<?php
									$questions = $conn->query("SELECT * FROM question_list where criteria_id = {$crow['id']} and event_id = $id order by abs(order_by) asc ");
